...
public class GetQuantileFromStringsSketchUDF extends UDF {
   ...
   * @param serializedSketch serialized sketch
   * @param inclusive if true, the interval is inclusive of the left split point and exclusive of the right split point   * @param fraction value from 0 to 1 inclusive
   * @return quantile value
   */
